...
import { Trophy, Film, Gamepad2, Search, BarChart3, Home, X } from "lucide-react";
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          // Mobile: fixed drawer, controlled by store
      ...
      >
        ...
        <div className="flex h-16 items-center gap-2 border-b border-border px-5">
          ...
          <button
            onClick={closeSidebar}
            className="flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground hover:text-foreground transition-colors lg:hidden"
